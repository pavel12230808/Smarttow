...
public class GetPendingFinesAdapter extends BaseAdapter {
    List<PaymentDuePojo> ar;
    Context cnt;


    public GetPendingFinesAdapter(List<PaymentDuePojo> ar, Context cnt) {
        this.ar = ar;
        this.cnt = cnt;
    }
    ...
    public View getView(final int pos, View view, ViewGroup viewGroup) {
        ...
        View obj2 = obj1.inflate(R.layout.row_get_pending_fine_, null);
