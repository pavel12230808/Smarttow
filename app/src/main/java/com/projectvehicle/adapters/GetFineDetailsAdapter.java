...
public class GetFineDetailsAdapter extends BaseAdapter {
    List<PaymentDuePojo> ar;
    Context cnt;


    public GetFineDetailsAdapter(List<PaymentDuePojo> ar, Context cnt) {
        this.ar = ar;
        this.cnt = cnt;
    }
    ...
    public View getView(final int pos, View view, ViewGroup viewGroup) {
        ...
        View obj2 = obj1.inflate(R.layout.row_get_fine_dretails, null);
        ...
        tv_sname.setText("Station Name:  "+ar.get(pos).getSname());
        ...
        tv_sname.setTypeface(custom_font);
        btn_pay.setTypeface(custom_font);
